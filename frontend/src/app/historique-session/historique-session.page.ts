...
export class HistoriqueSessionPage implements OnInit {
  ...
  plantes = [
    ...
    { created_at: '04/02/23', rapport: 'Ta plante est possédée aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', sessionpic: 'https://www.smashbros.com/assets_v2/img/fighter/piranha_plant/main.png'},
    ...
    { created_at: '02/02/23', rapport: 'Ta plante a disparu', sessionpic: 'https://m.media-amazon.com/images/I/51vokPIQivL._AC_SY550_.jpg'},
    { created_at: '01/02/23', rapport: 'RAS mon reuf', sessionpic: 'https://i.ytimg.com/vi/83tSUi5YbCQ/maxresdefault.jpg' },
  ];
